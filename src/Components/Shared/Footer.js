...
const Footer = () => {
    ...
    return (
        <div>
            ...
            <footer className="bg-slate-700 rounded-lg  text-center lg:text-left mt-20">
                <div className="text-gray-300 flex justify-around  items-center p-4" style={{ backgroundColor: "rgba(0, 0, 0, 0.2)" }}>
                    ...
                    <div>
                        <div className='flex'>
                            <a target='_blank' rel="noreferrer" href="https://www.facebook.com/Shimul.SCD/" className='text-4xl '><FaFacebookSquare className='text-gray-300 my-2 mr-5' /></a>
